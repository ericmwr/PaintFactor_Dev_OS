...
const LEGACY_TASKS = [
  // TSK_TRIM_PAINT_PROTECT_TEARDOWN + TSK_TRIM_PAINT_REMOVE_WALL_MASK remain
  // active via MOD_TEMPLATE_TRIM_CLEANUP_PAINT (inherited by per-substrate cleanup
  // modules). Kept on the legacy watchlist in case they need re-classification
  // once the finish-group V1a path takes over their role.
