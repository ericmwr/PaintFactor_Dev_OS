...
const PROBES = [
  ...
  { label: 'Wainscot field-primed QT3 brush (no caulk)', ctx: { paintable_item: 'wainscot', quality_tier: 'QT3', application_method: 'brush', substrate_state: 'SS_PRIMED_FIELD' }, qty: { 'PS_SURFACE_SF.WAINSCOTING': 100 } },
  ...
  { label: 'Arch NC QT3 brush — columns', ctx: { paintable_item: 'arch_element', quality_tier: 'QT3', application_method: 'brush', substrate_state: 'SS_BARE' }, qty: { 'PS_SURFACE_LF.ARCH_COLUMN': 64 } },
