...
| TSK_WALL_PROTECT_SETUP | SF | IN_SF_FLOOR_PROTECTION_AREA | PS_PROTECT_SF.FLOOR_EXPOSED |
...
| TSK_WALL_PROTECT_REMOVE | SF | IN_SF_FLOOR_PROTECTION_AREA | PS_PROTECT_SF.FLOOR_EXPOSED |
