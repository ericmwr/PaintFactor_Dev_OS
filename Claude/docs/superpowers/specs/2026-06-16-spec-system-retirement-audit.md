...
**Verification:** `npx vitest run` → **168 passed** (170 baseline + 1 new material golden − 3 retired shim-integrity cases); `npx vite build` → green, **258 modules**; NC-interior parity **21.13** and exterior **1.73** held EXACT through every task.
