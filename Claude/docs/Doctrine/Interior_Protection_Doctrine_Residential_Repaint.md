# Interior Protection Doctrine (Residential Repaint)

**Status:** Draft
**Version:** 0.1.0
**Last Updated:** 2026-01-25

This document defines how painting professionals protect floors, furniture, fixtures, and adjacent surfaces during interior residential repaint operations. AI agents generating specs MUST follow this doctrine when defining protection tasks, consumables, and customer expectations.
...
|--------------|------------------|
| New construction (pre-trim, no flooring) | NC Protection rules in spec research |
