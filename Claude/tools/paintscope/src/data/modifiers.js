...
export const DOOR_TYPE_MODIFIERS = { flush: 1.0, panel_4: 1.25, panel_6: 1.35, french: 2.0, bifold: 0.7, louvered: 2.5 };
...
export const DOOR_TYPE_LABELS = { flush:'Flush/Slab', panel_4:'4-Panel', panel_6:'6-Panel', french:'French', bifold:'Bifold', louvered:'Louvered' };
