...
export const QUANTITY_KEY_LABELS = {
  ...
  'PS_EDGE_LF.TRIM_JOINTS_WAINSCOT_CAP': 'Wainscot Cap Joints',
  ...
  'PS_EDGE_LF.CUTIN_WALL_TO_WAINSCOT_CAP': 'Cut-In Wall to Wainscot Cap',
  ...
  'PS_PROTECT_LF.TRIM_WAINSCOT_CAP': 'Wainscot Cap Mask',
