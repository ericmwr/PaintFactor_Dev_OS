...
export const SUBSTRATE_SYSTEMS = {
  ...
  wainscot_cap:      ['paint_full', 'paint_finish', 'stain_clear', 'stain_sealer_clear', 'prime_only'],
...
export const DEFAULT_SYSTEM_INFERENCE = {
  ...
  wainscot_cap:      { bare_wood: 'paint_full', factory_primed: 'paint_finish', painted_wood: 'paint_finish' },
