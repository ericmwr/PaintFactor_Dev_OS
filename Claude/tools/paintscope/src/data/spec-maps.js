...
export const SPEC_ROLE = {
  ...
  'SF_WAINSCOT_CAP_NC_PAINT':     'FINISH',
  'SF_WAINSCOT_CAP_NC_PRIME':     'PRIME',
...
export const SPEC_VALID_INPUT_STATES = {
  ...
  'SF_WAINSCOT_CAP_NC_PAINT':    ['SS_PRIMED','SS_PRIMED_FIELD','SS_PRIMED_FACTORY'],
  'SF_WAINSCOT_CAP_NC_PRIME':    ['SS_BARE'],
...
export const SPEC_OUTPUT_STATES = {
  ...
  'SF_WAINSCOT_CAP_NC_PRIME':    'SS_PRIMED_FIELD',
...
export const GRAIN_FILL_PARENT_SPEC = {
  ...
  'wainscot_cap':    'SF_WAINSCOT_CAP_NC_PAINT',
