...
export const SPEC_ROLE = {
  ...
  'SF_WINDOW_JAMB_NC_FINISH':     'COMBINED',
  'SF_WINDOW_JAMB_NC_PRIME':      'PRIME',
  'SF_WINDOW_CASING_NC_PAINT':    'COMBINED',
...
export const SPEC_VALID_INPUT_STATES = {
  ...
  'SF_WINDOW_JAMB_NC_FINISH':    ['SS_PRIMED_FIELD','SS_PRIMED_FACTORY'],
  'SF_WINDOW_JAMB_NC_PRIME':     ['SS_BARE'],
  'SF_WINDOW_CASING_NC_PAINT':   ['SS_PRIMED_FIELD','SS_PRIMED_FACTORY'],
