...
export function buildRoomQuantityLookups(state) {
  ...
  rooms.forEach((room, ri) => {
    ...
    const TRIM_TOTAL_EXCLUDED = new Set(['window_casing', 'door_casing', 'crown', 'chair_rail', 'shoe_mold', 'picture_rail', 'wainscot_cap', 'window_stool', 'window_apron', 'shadow_box', 'panel_mold']);
