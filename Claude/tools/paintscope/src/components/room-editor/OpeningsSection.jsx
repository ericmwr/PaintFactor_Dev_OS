...
export default function OpeningsSection({ room, derived, dispatch, project }) {
  const rid = room.id;
  ...
  return (
    <div className="panel-section" data-section="openings">
      <div className="section-title">Openings</div>
