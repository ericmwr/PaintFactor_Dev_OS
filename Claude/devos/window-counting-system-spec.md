...
Height tiers drive labor modifiers based on access difficulty.

| Tier | Label | Range | Modifier | Access Method |
|------|-------|-------|----------|---------------|
| H1 | ≤8′ | 0–8 ft | 1.00x | Ground / step stool |
| H2 | 9-13′ | 9–13 ft | 1.25x | Step ladder / extension ladder |
| H3 | 14-18′ | 14–18 ft | 1.50x | Extension ladder / scaffolding |
| H4 | 19+′ | 19+ ft | 1.75x | Scaffolding / lift equipment |
